...
import { receipts, requests, summary, tools } from "@/lib/mock/data";
    ...
    <div className="space-y-10">
      ...
      <div className="hairline grid grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard
          ...
          value={summary.avgSettlementMs.toString()}
          unit="ms"
        />
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <section className="xl:col-span-2">
          <div className="flex items-baseline justify-between mb-4">
            ...
            <Link to="/dashboard/receipts" className="text-xs text-muted-foreground hover:text-foreground">
              View all →
            </Link>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="hairline-b text-muted-foreground">
                  ...
                  <th className="text-right px-4 py-3 font-normal text-xs uppercase tracking-wider">When</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section>
        ...
        <div className="hairline mt-4 grid grid-cols-1 md:grid-cols-3 gap-px bg-hairline">
          {tools.filter((t) => t.enabled).slice(0, 6).map((t) => (
