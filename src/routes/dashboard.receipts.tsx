...
import { receipts as initialReceipts } from "@/lib/mock/data";
          ...
          <table className="w-full text-sm min-w-[900px]">
            <thead>
              <tr className="hairline-b text-muted-foreground">
                <th className="text-left px-4 py-3 font-normal text-xs uppercase tracking-wider">Request</th>
                <th className="text-left px-4 py-3 font-normal text-xs uppercase tracking-wider">Tool</th>
                <th className="text-left px-4 py-3 font-normal text-xs uppercase tracking-wider">Payer</th>
                <th className="text-left px-4 py-3 font-normal text-xs uppercase tracking-wider">Tx Signature</th>
                <th className="text-right px-4 py-3 font-normal text-xs uppercase tracking-wider">Amount</th>
                <th className="text-right px-4 py-3 font-normal text-xs uppercase tracking-wider">Block time</th>
              </tr>
            </thead>
            <tbody>
              {filtered.map((r) => (
                <tr key={r.id} className="hairline-b last:border-b-0 hover:bg-card/50">
                  ...
                  <td className="px-4 py-3 font-mono text-muted-foreground">{truncate(r.payerWallet)}</td>
                  ...
                  <td className="px-4 py-3 text-right text-muted-foreground">{fmtRelative(r.blockTime)}</td>
                </tr>
              ))}
            </tbody>
          </table>
