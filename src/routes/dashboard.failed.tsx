          ...
          <table className="w-full text-sm min-w-[820px]">
            <thead>
              <tr className="hairline-b text-muted-foreground">
                ...
                <th className="text-left px-4 py-3 font-normal text-xs uppercase tracking-wider">Reason</th>
            ...
            <tbody>
              {filtered.map((r) => (
                <tr key={r.id} className="hairline-b last:border-b-0 hover:bg-card/50">
                  ...
                  <td className="px-4 py-3 text-right text-muted-foreground">{fmtRelative(r.createdAt)}</td>
