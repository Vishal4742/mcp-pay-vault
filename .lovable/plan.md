...
5. **Big-copy section** — asymmetric grid (col 5/12), editorial paragraph with hover-highlighted phrases: *"Wrap an existing MCP server in minutes. Price tools individually. Settle on Solana. Inspect every receipt."*
